...
#include <vector>
#include <memory>
#include "GLViewNetTestModule.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewNetTestModule > glView( Aftr::GLViewNetTestModule::New( args ) );
